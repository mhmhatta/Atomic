<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/compound3.css">
    </head>
    <body>
        <div class="container">
        <a href="menu.php"><svg class="back" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <a href="../questions/compoundjs/cq.php">
                <div class="start">Quiz Practice !</div>
            </a>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
    ...
    <a href="compound2.php"><h1 class="number2">2</h1></a>
