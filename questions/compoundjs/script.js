...
exit_btn.onclick = ()=>{
    ...
    window.location.href = "../php/group1.php";
}
...
function showQuetions(index){
    ...
    let image = '<div class = "que_image"><img src ="' + questions[index].image + '"></div>';
    que_text.innerHTML = que_tag; //adding new span tag inside que_tag
    option_list.innerHTML = option_tag; //adding new div tag inside option_tag
    
    que_image.innerHTML = image;
...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span>Keep Learning!😎, You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
